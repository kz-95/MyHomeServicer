...
export const children: SeedChildCategory[] = [
  // ── Cleaning Service ──
  {
    ...
    icon: 'sparkles', price: 60, duration: 120, photosEnabled: false,
    questions: [
      {
        ...
        options: [
          { value: '1h_2c', label: '1 hour × 2 cleaners (recommended for studio)' },
          { value: '2h_2c', label: '2 hours × 2 cleaners (recommended for 2 bedroom apartment)' },
          { value: '3h_2c', label: '3 hours × 2 cleaners (recommended for 2–3 bedroom home)' },
          { value: '4h_2c', label: '4 hours × 2 cleaners (recommended for semi-d or bungalow)' },
        ],
      },
      {
        key: 'cleaning_supplies', label: 'Do you need us to provide cleaning supplies?', type: 'radio', required: true, priced: false,
        options: [
          { value: 'single_session', label: 'Single session (supplies provided)' },
          { value: 'no_i_provide', label: 'No, I will provide (RM0)' },
        ],
      },
      {
        key: 'pets', label: 'Do you have any pet(s)?', type: 'checkbox', required: true, priced: false,
        minSelect: 1,
        options: [
  ...
  {
    parentSlug: 'cleaning-service', slug: 'sofa-mattress-cleaning', name: 'Sofa / Mattress Cleaning',
    icon: 'sofa', price: 80, duration: 90, photosEnabled: false,
    questions: [
      {
        key: 'clean_for', label: 'Cleaning for:', type: 'checkbox', required: true, priced: true,
        minSelect: 1,
        options: [
      ...
      {
        key: 'sofa_size', label: 'Sofa size', type: 'radio', required: false, priced: true,
  ...
  {
    parentSlug: 'cleaning-service', slug: 'carpet-cleaning', name: 'Carpet Cleaning',
    icon: 'bubbles', price: 70, duration: 90, photosEnabled: false,
    questions: [
      {
        key: 'cleaning_type', label: 'Type of carpet cleaning?', type: 'radio', required: true, priced: true,
        options: [
          ...
          { value: 'carpet_small', label: 'Carpet Cleaning – Small room (~10×10 ft)' },
          { value: 'carpet_medium', label: 'Carpet Cleaning – Medium room (~20×20 ft)' },
          { value: 'carpet_large', label: 'Carpet Cleaning – Large room (~30×30 ft)' },
        ],
      },
    ],
  },
  {
    parentSlug: 'cleaning-service', slug: 'curtain-cleaning', name: 'Curtain Cleaning',
    icon: 'sun', price: 50, duration: 60, photosEnabled: false,
    questions: [
      {
        key: 'curtain_sizes', label: 'Choose your curtain sizes', type: 'quantity', required: true, priced: true,
        options: [
      ...
      {
        key: 'cleaning_type', label: 'Type of cleaning', type: 'radio', required: true, priced: true,
        options: [
  ...
  // ── Events ──
  {
    ...
    icon: 'party-popper', price: 1000, duration: 300, photosEnabled: true,
    questions: [
      {
        ...
        options: [
          ...
          { value: 'wedding_reception', label: 'Wedding reception / lunch / dinner' },
          { value: 'pre_wedding_portraits', label: 'Pre-wedding portraits (outdoor, studio)' },
          { value: 'studio_portrait', label: 'Studio or portrait session (family, baby, pets, graduation, etc)' },
          { value: 'private_event', label: 'Private event or party (birthday, office, school)' },
          { value: 'corporate_event', label: 'Corporate event (seminar, product launch, etc)' },
          { value: 'others', label: 'Others' },
        ],
      },
      {
        key: 'venue', label: 'Where will your event be held?', type: 'radio', required: true, priced: false,
        options: [
      ...
      {
        key: 'attendees', label: 'How many attendees will be there?', type: 'number', required: false, priced: false,
      },
      {
        key: 'planning_services', label: 'What event/wedding planning services do you need?', type: 'checkbox', required: true, priced: true,
        minSelect: 1,
        options: [
          ...
          { value: 'floor_activity', label: 'Managing floor activity on the day' },
        ],
      },
      {
        key: 'vendors', label: 'What vendors need to be sourced?', type: 'checkbox', required: false, priced: false,
        options: [
      ...
      {
        key: 'duration_hours', label: 'Duration of event (hours)', type: 'number', required: false, priced: false,
      },
      {
        key: 'details', label: 'Share as much detail as you can for the vendor to give a good cost estimate.', type: 'text', required: false, priced: false,
      },
    ],
  },
  {
    parentSlug: 'events-weddings', slug: 'catering', name: 'Catering Service',
    icon: 'chef-hat', price: 50, duration: 180, photosEnabled: false,
    questions: [
      {
      ...
      },
      {
        ...
        options: [
          ...
          { value: 'wedding_reception', label: 'Wedding reception / lunch / dinner' },
          { value: 'private_event', label: 'Private event or party (birthday, office, school)' },
          { value: 'corporate_event', label: 'Corporate event (seminar, product launch)' },
          { value: 'daily_meal_sets', label: 'Daily meal sets' },
          { value: 'others', label: 'Others' },
        ],
      },
      {
        key: 'cuisine', label: 'Type of cuisine', type: 'checkbox', required: true, priced: false,
        minSelect: 1,
        options: [
      ...
      {
        key: 'service_mode', label: 'On-site or Delivery?', type: 'radio', required: true, priced: false,
        options: [
      ...
      {
        key: 'utensils_table', label: 'Do you need utensils or table?', type: 'checkbox', required: false, priced: false,
        options: [
      ...
      {
        key: 'pax', label: 'Number of guests (pax)', type: 'quantity', required: true, priced: true,
  ...
  // ── Home Improvement ──
  {
    parentSlug: 'home-improvement', slug: 'professional-organizer', name: 'Professional Organizer',
    icon: 'layout', price: 80, duration: 120, photosEnabled: true,
    questions: [
      {
        key: 'space', label: 'Which space(s) to organize?', type: 'checkbox', required: true, priced: false,
        minSelect: 1,
        options: [
      ...
      {
        key: 'service_type', label: 'What do you need?', type: 'checkbox', required: true, priced: false,
        minSelect: 1,
        options: [
      ...
      {
        key: 'home_size', label: 'Home size', type: 'radio', required: true, priced: true,
        options: [
      ...
      {
        key: 'supplies', label: 'Need us to provide storage supplies (boxes, organizers)?', type: 'radio', required: true, priced: false,
        options: [
          { value: 'yes_provide', label: 'Yes (supplies provided — pass-through fee applies)' },
  ...
  {
    parentSlug: 'home-improvement', slug: 'aircond-installer', name: 'Aircond Installer',
    icon: 'wind', price: 400, duration: 180, photosEnabled: true,
    questions: [
      {
        key: 'units', label: 'What type of aircon requires installation?', type: 'quantity', required: true, priced: true,
  ...
  {
    parentSlug: 'home-improvement', slug: 'carpenter', name: 'Carpenter',
    icon: 'hammer', price: 150, duration: 120, photosEnabled: true,
    questions: [
      {
        key: 'action', label: 'What do you need?', type: 'radio', required: true, priced: true,
        options: [
      ...
      {
        key: 'item', label: 'What item?', type: 'checkbox', required: true, priced: true,
        minSelect: 1,
        options: [
      ...
      {
        key: 'material', label: 'Material?', type: 'radio', required: false, priced: false,
        options: [
      ...
      {
        key: 'supply', label: 'Supply the materials?', type: 'radio', required: true, priced: false,
        options: [
          { value: 'yes_supply_build', label: 'Yes, supply + build (normal priced)' },
          { value: 'no_i_have_materials', label: 'No, I have materials (labor only)' },
        ],
      },
    ],
  },
  {
    parentSlug: 'home-improvement', slug: 'renovation', name: 'Renovation',
    icon: 'hard-hat', price: 500, duration: 240, photosEnabled: true, requiresInspection: true,
    questions: [
      {
        key: 'project_type', label: 'Renovation type?', type: 'radio', required: true, priced: false,
        options: [
      ...
      {
        key: 'scope', label: 'What work?', type: 'checkbox', required: true, priced: false,
        minSelect: 1,
        options: [
      ...
      {
        key: 'property_status', label: 'Property status?', type: 'radio', required: true, priced: false,
        options: [
      ...
      {
        key: 'size', label: 'Approx area (sqft)?', type: 'number', required: false, priced: false,
      },
      {
        key: 'details', label: 'Describe your renovation plan.', type: 'text', required: false, priced: false,
      },
    ],
  },
  {
    parentSlug: 'home-improvement', slug: 'interior-design', name: 'Interior Design',
    icon: 'paintbrush', price: 300, duration: 180, photosEnabled: true,
    questions: [
      {
        key: 'service_level', label: 'Service level?', type: 'radio', required: true, priced: true,
        options: [
      ...
      {
        key: 'scope', label: 'Scope?', type: 'radio', required: true, priced: false,
        options: [
          { value: 'single_room', label: 'Single room' },
          { value: 'whole_home', label: 'Whole home' },
          { value: 'commercial_office', label: 'Commercial/Office' },
      ...
      {
        key: 'rooms', label: 'Which space(s)?', type: 'checkbox', required: true, priced: false,
        minSelect: 1,
        options: [
      ...
      {
        key: 'style', label: 'Preferred style(s)?', type: 'checkbox', required: false, priced: false,
        minSelect: 0,
        options: [
      ...
      {
        key: 'details', label: 'Describe your vision / requirements.', type: 'text', required: false, priced: false,
      },
    ],
  },
  {
    parentSlug: 'home-improvement', slug: 'door-gate', name: 'Door Gate',
    icon: 'door-open', price: 100, duration: 90, photosEnabled: true,
    questions: [
      {
        key: 'action', label: 'What do you need?', type: 'radio', required: true, priced: true,
        options: [
      ...
      {
        key: 'gate_type', label: 'Gate/door type?', type: 'checkbox', required: true, priced: true,
        minSelect: 1,
        options: [
      ...
      {
        key: 'component', label: 'What part? (if repair)', type: 'checkbox', required: false, priced: false,
        minSelect: 0,
        options: [
      ...
      {
        key: 'problem', label: 'Problem?', type: 'checkbox', required: false, priced: false,
        minSelect: 0,
        options: [
  ...
  {
    parentSlug: 'home-improvement', slug: 'roof', name: 'Roof',
    icon: 'home', price: 200, duration: 120, photosEnabled: true, requiresInspection: true,
    questions: [
      {
        key: 'action', label: 'What do you need?', type: 'radio', required: true, priced: false,
        options: [
      ...
      {
        key: 'roof_type', label: 'Roof type?', type: 'radio', required: false, priced: false,
        options: [
      ...
      {
        key: 'details', label: 'Describe + location of issue.', type: 'text', required: false, priced: false,
      },
    ],
  },
  // ── Home Maintenance ──
  ...
  {
    parentSlug: 'home-maintenance', slug: 'plumber', name: 'Plumber',
    icon: 'wrench', price: 80, duration: 90, photosEnabled: true,
    questions: [
      {
        key: 'action', label: 'What kind of plumbing service?', type: 'radio', required: true, priced: true,
        options: [
      ...
      {
        key: 'area', label: 'Which area?', type: 'checkbox', required: true, priced: true,
        minSelect: 1,
        options: [
      ...
      {
        key: 'problem', label: 'What problem?', type: 'checkbox', required: true, priced: false,
        minSelect: 1,
        options: [
  ...
  {
    parentSlug: 'home-maintenance', slug: 'electrical-wiring', name: 'Electrical & Wiring',
    icon: 'zap', price: 80, duration: 60, photosEnabled: true,
    questions: [
      {
        key: 'action', label: 'What do you need?', type: 'radio', required: true, priced: true,
        options: [
  ...
  {
    parentSlug: 'appliance-repair', slug: 'washing-machine-repair', name: 'Washing Machine & Dryer Repair',
    icon: 'washing-machine', price: 80, duration: 60, photosEnabled: true,
    questions: [
      {
        key: 'appliance', label: 'Which appliance?', type: 'radio', required: true, priced: true,
        options: [
          { value: 'washing_machine_top', label: 'Washing machine (top load)' },
          { value: 'washing_machine_front', label: 'Washing machine (front load)' },
          { value: 'dryer', label: 'Dryer' },
          { value: 'washer_dryer_combo', label: 'Washer-dryer combo' },
        ],
      },
      {
        key: 'problem', label: 'Problem?', type: 'checkbox', required: true, priced: false,
        minSelect: 1,
        options: [
      ...
      {
        key: 'brand', label: 'Brand & model (if known)', type: 'text', required: false, priced: false,
      },
    ],
  },
  {
    parentSlug: 'appliance-repair', slug: 'refrigerator-repair', name: 'Refrigerator Repair',
    icon: 'thermometer', price: 80, duration: 60, photosEnabled: true,
    questions: [
      {
        key: 'fridge_type', label: 'Type?', type: 'radio', required: true, priced: true,
        options: [
  ...
  {
    parentSlug: 'appliance-repair', slug: 'tv-repair', name: 'TV Repair',
    icon: 'tv', price: 60, duration: 45, photosEnabled: true,
    questions: [
      {
        key: 'tv_type', label: 'TV type?', type: 'radio', required: true, priced: true,
        options: [
      ...
      {
        key: 'brand', label: 'Brand, model & screen size (if known)', type: 'text', required: false, priced: false,
      },
    ],
  },
  {
    parentSlug: 'appliance-repair', slug: 'oven-repair', name: 'Oven Repair',
    icon: 'flame', price: 70, duration: 60, photosEnabled: true,
    questions: [
      {
        key: 'oven_type', label: 'Type?', type: 'radio', required: true, priced: true,
        options: [
  ...
  {
    parentSlug: 'appliance-repair', slug: 'water-heater-repair', name: 'Water Heater Repair',
    icon: 'droplets', price: 80, duration: 60, photosEnabled: true,
    questions: [
      {
        key: 'heater_type', label: 'Type?', type: 'radio', required: true, priced: true,
        options: [
  ...
  {
    parentSlug: 'appliance-repair', slug: 'ceiling-fan-repair', name: 'Ceiling Fan Repair',
    icon: 'fan', price: 60, duration: 45, photosEnabled: true,
    questions: [
      {
        key: 'fan_type', label: 'Type?', type: 'radio', required: true, priced: true,
        options: [
  ...
  {
    parentSlug: 'appliance-repair', slug: 'aircond-repair', name: 'Aircond Repair',
    icon: 'wrench', price: 80, duration: 60, photosEnabled: true,
    questions: [
      {
        key: 'aircon_type', label: 'Type?', type: 'radio', required: true, priced: true,
        options: [
      ...
      {
        key: 'units', label: 'How many units?', type: 'number', required: false, priced: false,
      },
      {
        key: 'brand', label: 'Brand & model (if known)', type: 'text', required: false, priced: false,
      },
  ...
  {
    parentSlug: 'training-classes', slug: 'art-class', name: 'Art Class',
    icon: 'palette', price: 60, duration: 60, photosEnabled: false,
    questions: [
      {
        key: 'art_type', label: 'Art focus?', type: 'checkbox', required: true, priced: false,
        minSelect: 1,
        options: [
      ...
      {
        key: 'level', label: 'Level?', type: 'radio', required: true, priced: false,
        options: [
      ...
      {
        key: 'format', label: 'Format?', type: 'radio', required: true, priced: true,
        options: [
      ...
      {
        key: 'frequency', label: 'Frequency?', type: 'radio', required: true, priced: false,
        options: [
      ...
      {
        key: 'learner', label: "Who's learning?", type: 'radio', required: true, priced: false,
        options: [
  ...
  {
    parentSlug: 'training-classes', slug: 'language-class', name: 'Language Class',
    icon: 'languages', price: 60, duration: 60, photosEnabled: false,
    questions: [
      {
        key: 'language', label: 'Which language?', type: 'checkbox', required: true, priced: false,
        minSelect: 1,
        options: [
      ...
      {
        key: 'goal', label: 'Goal?', type: 'radio', required: true, priced: false,
        options: [
  ...
  {
    parentSlug: 'training-classes', slug: 'music-class', name: 'Music Class',
    icon: 'music', price: 70, duration: 60, photosEnabled: false,
    questions: [
      {
        key: 'instrument', label: 'Instrument/focus?', type: 'checkbox', required: true, priced: true,
        minSelect: 1,
        options: [
  ...
  {
    parentSlug: 'training-classes', slug: 'home-tutoring', name: 'Home Tutoring',
    icon: 'book', price: 60, duration: 60, photosEnabled: false,
    questions: [
      {
        key: 'level', label: 'Education level?', type: 'radio', required: true, priced: true,
        options: [
      ...
      {
        key: 'subjects', label: 'Subjects?', type: 'checkbox', required: true, priced: false,
        minSelect: 1,
        options: [
      ...
      {
        key: 'students', label: 'How many students?', type: 'number', required: false, priced: false,
      },
    ],
  },
  {
    parentSlug: 'training-classes', slug: 'cooking-class', name: 'Cooking Class',
    icon: 'utensils-crossed', price: 80, duration: 90, photosEnabled: false,
    questions: [
      {
        key: 'cuisine', label: 'Cuisine/focus?', type: 'checkbox', required: true, priced: false,
        minSelect: 1,
        options: [
          { value: 'malay', label: 'Malay' },
          { value: 'chinese', label: 'Chinese' },
      ...
      {
        key: 'setup', label: 'Class type?', type: 'radio', required: true, priced: true,
        options: [
      ...
      {
        key: 'ingredients', label: 'Provide ingredients?', type: 'radio', required: true, priced: false,
        options: [
  ...
  {
    parentSlug: 'training-classes', slug: 'gym-trainer', name: 'Private Gym Trainer',
    icon: 'dumbbell', price: 80, duration: 60, photosEnabled: false,
    questions: [
      {
        key: 'goal', label: 'Goal?', type: 'checkbox', required: true, priced: false,
        minSelect: 1,
        options: [
      ...
      {
        key: 'format', label: 'Where?', type: 'radio', required: true, priced: true,
        options: [
          { value: 'at_my_home', label: 'At my home' },
      ...
      {
        key: 'trainee', label: 'Who?', type: 'radio', required: true, priced: true,
        options: [
      ...
      {
        key: 'gender_pref', label: 'Trainer gender preference?', type: 'radio', required: true, priced: false,
        options: [
  ...
  {
    parentSlug: 'training-classes', slug: '3d-modeling-class', name: '3D Modeling Class',
    icon: 'box', price: 100, duration: 90, photosEnabled: false,
    questions: [
      {
        key: 'field', label: 'What field / industry?', type: 'checkbox', required: true, priced: true,
        minSelect: 1,
        options: [
      ...
      {
        key: 'software', label: 'Software preference?', type: 'checkbox', required: true, priced: false,
        minSelect: 1,
        options: [
      ...
      {
        key: 'goal', label: 'Describe what you want to create / your project.', type: 'text', required: false, priced: false,
      },
    ],
  },
  // ── Tech & IT ──
  {
    parentSlug: 'tech-it', slug: 'alarm-cctv', name: 'Alarm & CCTV Services',
    icon: 'camera', price: 150, duration: 120, photosEnabled: true,
    questions: [
      {
        key: 'action', label: 'What do you need?', type: 'radio', required: true, priced: true,
        options: [
      ...
      {
        key: 'system_type', label: 'System type?', type: 'checkbox', required: true, priced: true,
        minSelect: 1,
        options: [
      ...
      {
        key: 'cameras', label: 'How many cameras/devices?', type: 'number', required: false, priced: false,
      },
      {
        key: 'location', label: 'Where?', type: 'checkbox', required: false, priced: false,
        minSelect: 0,
        options: [
      ...
      {
        key: 'supply', label: 'Supply the equipment?', type: 'radio', required: true, priced: false,
        options: [
          { value: 'yes_supply_install', label: 'Yes, supply + install' },
          { value: 'no_i_have_equipment', label: 'No, I have equipment (install only)' },
        ],
      },
    ],
  },
...
export const platformSettings: { key: string; value: unknown }[] = [
  ...
  { key: 'condo_entry_note', value: 'If you live in a condo, please inform your management and guide the servicer on how to enter your building. Each condo has its own visitor policy.' },
...
export const chatKnowledge: { category: string; question: string; answer: string; sortOrder: number; tier?: string }[] = [
