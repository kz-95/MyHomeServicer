...
REM ==========================================================
REM === MyHomeServicer — Test Seed Launcher ===================
REM === Fast iteration with lean test data (no 19 merchants) =
REM ==========================================================
if "%~1"=="" goto :main
...
echo.
echo ============================================
echo  MyHomeServicer — Test Seed Mode
echo  Lean data for fast iteration
echo ============================================
call :ensure_infra
...
echo.
start "Backend (Test)"  cmd /k call "%~f0" backend_only
timeout /t 3 >nul
start "Frontend (Test)" cmd /k call "%~f0" frontend_only
echo.
...
REM --- Install deps (reinstall if package-lock.json is newer than installed state) ---
powershell -NoProfile -Command ^
...
REM --- Apply test database schema + seed ---
echo.
echo ============================================
echo  Resetting DB + Test Seed (lean data)...
echo ============================================
call npm run db:reset-test
if errorlevel 1 (
    echo.
